...
abstract class HomeConst{
  ...
  static List<CategoryEntity> categoryList = [
    ...
    CategoryEntity(categoryName:classRoom,iconColor: const Color(0xFFF9614F),iconData:Icons.meeting_room_outlined,cardBg: const Color(0xffFFE0DD),navigateTo: RouteGenerator.classRoomListPage),
    CategoryEntity(categoryName:registration,iconColor: const Color(0xFFFDC441),iconData:Icons.edit,cardBg: const Color(0xffFFF3D9),navigateTo: RouteGenerator.registrationPage),
  ];
}