...
abstract class HomeConst{
  ...
  static List<CategoryEntity> categoryList = [
    ...
    CategoryEntity(categoryName:subjects,iconColor: const Color(0xFF3595FF),iconData:Icons.menu_book_outlined,cardBg: const Color(0xffD8EBFD),navigateTo: RouteGenerator.subjectPage),
